...
function createSupport() {
	...
	cube = new THREE.Mesh(
		new THREE.CubeGeometry(64, 334+54, 6), cubeMaterial );
	cube.position.x = 0;
	cube.position.y = (334+52)/2;
...
function createBody() {
	...
	var sphereRarius = 60;
	var cylinderLength = 300;
	
	sphere = new THREE.Mesh(
		new THREE.SphereGeometry(sphereRarius,32,16), sphereMaterial);
	sphere.position.x = 0;
	sphere.position.y =sphereRarius +100;
	sphere.position.z = 0;
	scene.add (sphere);
	
	cylinder = new THREE.Mesh(
		new THREE.CylinderGeometry(10,10, cylinderLength, 32),cylinderMaterial);
	cylinder.position.x = 0;
	cylinder.position.y =cylinderLength/2 + sphereRarius*2 +100;
...
function createHead() {
	...
	sphere = new THREE.Mesh(
		new THREE.SphereGeometry(sphereRarius,32,16), sphereMaterial);
	sphere.position.x = 0;
	sphere.position.y =sphereRarius +100 + 2*60 + 300;
	sphere.position.z = 0;
	scene.add (sphere);
	
	cylinder = new THREE.Mesh(
		new THREE.CylinderGeometry(70,70,10,32), cylinderMaterial);
	cylinder.position.x = 0;
	cylinder.position.y = 2*sphereRarius +100 + 2*60 + 300 -10;
	cylinder.position.z = 0;
	scene.add(cylinder);
	...
	cylinder.position.x = 0;
	cylinder.position.y = 2*sphereRarius +100 + 2*60 + 300 +  70/2 -10;
	cylinder.position.z = 0;
	scene.add(cylinder);
}
